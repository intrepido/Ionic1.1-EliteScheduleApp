'use strict';
angular.module('eliteApp').factory('eliteApi', ['$http', '$q', '$ionicLoading', 'CacheFactory', 'ApiEndpoint', function ($http, $q, $ionicLoading, CacheFactory, ApiEndpoint) {
  ...
  function getLeagueData(forceRefresh) {
    ...
    if (leagueData) {
      ...
      $http.get(ApiEndpoint.url + '/' + getLeagueId())
